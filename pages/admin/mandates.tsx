          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center gap-4">
                <Link href="/admin" className="text-xl font-bold text-gray-900">Vanalexcars Admin</Link>
                <span className="bg-yellow-100 text-yellow-800 text-xs font-bold px-2.5 py-0.5 rounded-full">Mandats</span>
              </div>
              <div className="flex items-center gap-3">
                <Link href="/admin/vehicles" className="text-sm text-gray-600 hover:text-gray-900">Véhicules</Link>
                <Link href="/admin-formulaires" className="text-sm text-gray-600 hover:text-gray-900">Formulaires</Link>
                <Link href="/" className="text-sm text-gray-600 hover:text-gray-900">Voir le site</Link>
              </div>
            </div>
          </div>
        </header>
