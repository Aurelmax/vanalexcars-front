...
export const AUTO_TERMS_DE_FR: Record<string, string> = {
  ...
  // Termes composés vus sur AS24
  'armlehne': 'Accoudoir',
  'berganfahrassistent': 'Assistant démarrage en côte',
  'einparkhilfe rückfahrkamera': 'Aide stationnement + caméra recul',
  'einparkhilfe sensoren hinten': 'Capteurs stationnement arrière',
  'einparkhilfe sensoren vorne': 'Capteurs stationnement avant',
  'elektrische fensterheber': 'Lève-vitres électriques',
  'elektrische seitenspiegel': 'Rétroviseurs électriques',
  'elektrische sitze': 'Sièges électriques',
  'lederausstattung': 'Sellerie cuir complète',
  'induktionsladen für smartphones': 'Chargeur induction smartphones',
  'induktionsladen': 'Chargeur induction',
  'innenspiegel automatisch abblendend': 'Rétroviseur intérieur antiéblouissant auto',
  'sprachsteuerung': 'Commande vocale',
  'touchscreen': 'Écran tactile',
  'windschott (für cabrio)': 'Déflecteur de vent cabriolet',
  'windschott': 'Déflecteur de vent',
  'fahrerairbag': 'Airbag conducteur',
  'beifahrerairbag': 'Airbag passager',
  'seitenairbag': 'Airbag latéral',
  'servolenkung': 'Direction assistée',
  'traktionskontrolle': 'Contrôle de traction',
  'zentralverriegelung mit funkfernbedienung': 'Verrouillage centralisé télécommande',
  'geschwindigkeits-begrenzungsanlage': 'Limiteur de vitesse',
  'reifendruckkontrollsystem': 'Contrôle pression pneus',
